...
const SearchBar = ({ className, isTranslating, currentLanguage = "en", onLanguageChange }: SearchBarProps) => {
    ...
    <div className={cn("relative w-full max-w-md", className)}>
      ...
      <div className="relative">
        ...
        <Input
          ...
          className="pl-10 pr-20 h-11 rounded-full border-border bg-background/80 backdrop-blur focus:bg-background shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]"
        />
        ...
        <div className="absolute right-2 top-1/2 transform -translate-y-1/2 flex items-center gap-1">
          ...
          <Badge 
            variant="secondary" 
            className="h-7 px-2 text-xs bg-muted/80 hover:bg-muted cursor-pointer"
            onClick={() => onLanguageChange?.(currentLanguage === "en" ? "auto" : "en")}
          >
            ...
            <CardContent className="p-4">
              {isSearching ? (
                ...
                <div className="space-y-2">
                  ...
                  {results.map((result, index) => (
                    <div
                      ...
                      className="p-3 rounded-lg hover:bg-muted/50 cursor-pointer group transition-colors"
                    >
                ...
                <div className="space-y-2">
                  ...
                  {["General English", "Summer Programme", "Brighton", "Pricing", "Contact"].map((term) => (
                    <div
                      key={term}
                      onClick={() => setQuery(term)}
                      className="p-2 rounded-lg hover:bg-muted/50 cursor-pointer text-sm transition-colors"
                    >
